import SwiftUI
/**
 * - Description: This extension provides additional functionality to the NavigationSplitViewColumn enumeration. It adds a computed property that returns a string representation of the column, which can be useful for debugging and logging purposes.
