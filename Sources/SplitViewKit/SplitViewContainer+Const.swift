...
extension SplitViewContainer {
    ...
    */
   public typealias SideBarAlias = (_ splitConfig: SplitConfig) -> SideBar
   /**
    ...
    */
   public typealias MainAlias = (_ splitConfig: SplitConfig) -> Content
   /**
    ...
    */
   public typealias DetailAlias = (_ splitConfig: SplitConfig) -> Detail
}
