...
internal struct MainHeader: View {
   /**
    * - Description: The title of the MainHeader, which is displayed
    *                prominently at the top of the view.
    */
   ...
   /**
    * - Description: Dismisses the current view, typically used to navigate
